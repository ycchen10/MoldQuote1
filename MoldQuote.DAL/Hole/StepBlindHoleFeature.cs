...
namespace MoldQuote.DAL
{
    ...
    /// 台阶通孔
    /// </summary>
    public class StepBlindHoleFeature : AbstractHoleFeater
    {
        /// <summary>
        /// 台阶数
        /// </summary>
        ...
        public StepBlindHoleFeature(HoleBuilder builder) : base(builder)
        {
        ...
        protected override void GetStartAndEndPt()
        {
            ...
            this.EndPt = this.Builder.CylFeater[this.Builder.CylFeater.Count - 1].Cylinder.EndPt;
        }
